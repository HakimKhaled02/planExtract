                                                            ...
                                                            <td class="px-3 py-2 text-gray-600 dark:text-gray-300 border-r border-gray-200 dark:border-gray-700 whitespace-nowrap">
                                                                <div x-data="{ 
                                                                    ...
                                                                    <div x-show="open" style="display: none;"
                                                                        ...
                                                                        class="absolute z-[100] mt-1 left-0 w-[150px] bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none p-1.5 space-y-1">
                                                                        
                                                                        <div @click="updateStatus('')" class="cursor-pointer text-[10px] font-bold px-2 py-1.5 rounded bg-gray-100 text-gray-900 hover:opacity-80">- Select -</div>
